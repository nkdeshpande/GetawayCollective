...
export const FAQ: readonly (readonly [string, string, string])[] = [
  ...
  ["How many nights come with a unit?", "Nights follow your share of the equity. The exact allocation rule is an open decision, and each offering letter will state it. Until then, this page does not.", "DECISIONS.md D-08"],
  ...
  ["Who maintains the estate?", "Sensory Getaways, the operating partner, under a Commercial Services Agreement measured on service levels. The sinking fund, stage four, pays for long-term renewal.", "L1-01 56 · L1-16"],
