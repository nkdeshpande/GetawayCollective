...
describe("workspace module taxonomy", () => {
  ...
  it("partitions the Office realm into eleven general routes and 54 vehicle IA records", () => {
    ...
    expect(general).toHaveLength(11); // 9 + the investor record's two, 25 Sep 2026
