 ...
 *
 * Route     /member/holdings/[property]
...
export const metadata: Metadata = {
  title: "Holding · Getaway Collective",
  robots: { index: true, follow: true },
};

export default async function Pmember_holdings_property(props: { params: Promise<{ property: string }> }) {
